...
- When this repo is the target, prefer `../.claude-plugin/plugin.json` as the canonical installed config source over `.claude/settings.json` unless the task is explicitly about the local mirror
